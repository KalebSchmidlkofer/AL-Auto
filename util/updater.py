...
class UpdateUtil(object):
    ...
    def checkUpdate(self):
        ...
        if self.config.updates['channel'] == 'Release':
            ...
            try:
                with request.urlopen("https://api.github.com/repos/KalebSchmidlkofer/ALAuto/releases/latest") as f:
            ...
            try:
                with request.urlopen("https://raw.githubusercontent.com/KalebSchmidlkofer/ALAuto/master/version.txt") as f:
